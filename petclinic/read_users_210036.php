  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div class="scrollable">
        ...
        $query = "SELECT*FROM users_210036"; // make a sql query
        ...
        ?>
          <tbody>
            <tr>
            <td><?php echo $i++; ?></td>
                <td><?php echo $data['username_210036']; ?></td>
                <td><?php echo $data['usertype_210036']; ?></td>
                <td><?php echo $data['fullname_210036']; ?></td>
                <td><a href="edit_users_210036.php?id=<?=$data['userid_210036']?>">Edit User</a></td>
                <td><a href="delete_users_210036.php?id=<?=$data['userid_210036']?> " onclick="return confirm('Are You Sure Delete the User?')">Delete User</a></td>
                <td><a href="reset_password_210036.php?id=<?=$data['userid_210036'];?>&type=<?=$data['usertype_210036'];?>" onclick="return confirm('Are You Sure Reset the Password?')">Reset Password</a></td>
            </tr>
        <?php endforeach; ?>
        </table>
      </div>
