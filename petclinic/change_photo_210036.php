...
<head>
  ...
  <section id="breadcrumb" class="hoc clear">   
    ...
    <ul>
      ...
      <li><a href="change_photo_210036.php">Change Photo User</a></li>
    </ul>
  </section>
</div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <div id="comments">
        <h2>Change Photo</h2>
        <form method="POST" action="user_upload_210036.php" enctype="multipart/form-data">
          <div class="one_third first">
            <img class="imgl borderedbox inspace-5" src="upload/users/<?= $data['photo_210036'] ?>" width="30%">
          ...
          <input type="hidden" name="photo_210036" value="<?= $data['photo_210036'] ?>" />
