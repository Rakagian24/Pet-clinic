...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <div id="comments">
        <h2>Form Edit Pet</h2>
        <form action="update_doctors_210036.php" method="post">
        <?php
        ...
        ?>
          <div class="one_third first">
            ...
            <input type="text" name="doctor_name_210036" id="name" value="<?=$data['doctor_name_210036']?>" size="22" required>
          </div>
          <div class="one_third">
            <label for="gender">Gender <span>*</span></label>
            <input type="radio" name="doctor_gender_210036" id="radio" value="Male" <?=($data['doctor_gender_210036']=='Male') ?'checked':'';?> size="22" required> Male
            <input type="radio" name="doctor_gender_210036" id="radio" value="Female" <?=($data['doctor_gender_210036']=='Female') ?'checked':'';?> size="22" required> Female
          </div>
          <div class="one_third">
            <label for="name">Phone <span>*</span></label>
            <input type="text" name="doctor_phone_210036" id="name" value="<?=$data['doctor_phone_210036']?>" size="22" required>
          </div>
          <div class="block clear">
            <label for="address">Address</label>
            <textarea name="doctor_address_210036" id="address" cols="25" rows="10"><?=$data['doctor_address_210036']?></textarea>
          </div>
          <div>
