...
<head>
  ...
  <section id="breadcrumb" class="hoc clear">   
    <h6 class="heading">Doctors List</h6>
    <ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <a href="add_doctors_210036.php">Add New Doctor</a>
        <table>
          <thead>
            <tr>
              <th>No</th>
        ...
        $query = "SELECT*FROM doctors_210036"; // make a sql query
        ...
        ?>
          <tbody>
            <tr>
              <td><?php echo $i++; ?></td>
                <td><?php echo $data['doctor_name_210036']; ?></td>
                <td><?php echo $data['doctor_gender_210036']; ?></td>
                <td><?php echo $data['doctor_address_210036']; ?></td>
                <td><?php echo $data['doctor_phone_210036']; ?></td>
                <td align="center">
                  <a href="doctor_photo_210036.php?id=<?=$data['doctor_id_210036']?>"><img src="upload/doctors/<?= $data['doctor_photo_210036']; ?>" style="width:50px;height:50px;"></a>
                </td>
                <td><a href="edit_doctors_210036.php?id=<?=$data['doctor_id_210036']?>">Edit Doctor</a>
              </td>
                <td><a href="delete_doctors_210036.php?id=<?=$data['doctor_id_210036']?> " onclick="return confirm('Are You Sure?')">Delete Doctor</a></td>
            </tr>
        <?php endforeach; ?>
        </table>
      </div>
