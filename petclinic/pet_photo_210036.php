...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <div id="comments">
        <h2>Change Photo</h2>
        <form method="post" action="pet_upload_210036.php" enctype="multipart/form-data">
          <div class="one_third first">
            <img class="imgl borderedbox inspace-5" src="upload/pets/<?=$data['pet_photo_210036']; ?>">
          ...
          <div>
            ...
            <input type="hidden" name="pet_photo_210036" value="<?=$data['pet_photo_210036']?>" />
