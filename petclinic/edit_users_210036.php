...
<head>
  ...
  <section id="breadcrumb" class="hoc clear">   
    ...
    <ul>
      ...
      <li><a href="read_users_210036.php">User List</a></li>
      <li><a href="edit_users_210036.php">Edit User</a></li>
    </ul>
  </section>
</div>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <div id="comments">
        ...
        <form action="update_users_210036.php" method="post" enctype="multipart/form-data">
        <?php
            //call connection php mysql
            include "connection_210036.php";

            //make query SELECT FROM WHERE
            $query="SELECT * FROM users_210036 where userid_210036='$_GET[id]'";
        ...
        ?>
          <div class="one_third first">
            ...
            <input type="text" name="username_210036" id="name" value="<?=$data['username_210036']?>" size="22" required>
          </div>
          <div class="one_third">
            <label for="gender">Type <span>*</span></label>
            <input type="radio" name="usertype_210036" id="radio" value="Manager" <?=($data['usertype_210036']=='Manager') ?'checked':'';?> size="22" required> Manager
            <input type="radio" name="usertype_210036" id="radio" value="Staff" <?=($data['usertype_210036']=='Staff') ?'checked':'';?> size="22" required> Staff
          </div>
          <div class="one_third">
            <label for="name">Fullname <span>*</span></label>
            <input type="text" name="fullname_210036" id="name" value="<?=$data['fullname_210036']?>" size="22" required>
          </div>
          <br><br><br><br><br><br>
          <div>
            ...
            <input type="hidden" name="userid_210036" value="<?=$data['userid_210036']?>">
          </div>
        </form>
      </div>
</div>
