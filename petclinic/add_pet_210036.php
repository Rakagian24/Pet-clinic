...
<head>
            ...
            <li><a class="drop" href="#">Pages</a>
              <ul>
                ...
                <?php if($_SESSION['usertype']=='Manager') { ?>
                  ...
                  <li><a href="report_210036.php">Monthly Report</a></li>
                  <?php }?>
              </ul>
            </li>
  ...
  <section id="breadcrumb" class="hoc clear">   
    <h6 class="heading">Add New Pet</h6>
    <ul>
      <li><a href="index.php">Home</a></li>
      <li><a href="read_pet_210036.php">Pet List</a></li>
      <li><a href="add_pet_210036.php">Add Pet</a></li>
    </ul>
  </section>
</div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <div id="comments">
        <h2>Form Add Pets</h2>
        <form action="create_pet_210036.php" method="post">
          <div class="one_third first">
            <label for="name">Name <span>*</span></label>
            <input type="text" name="pet_name_210036" id="name" value="" size="22" required>
          </div>
          <div class="one_third">
            <label for="gender">Gender <span>*</span></label>
            <input type="radio" name="pet_gender_210036" id="radio" value="" size="22" required> Male
            <input type="radio" name="pet_gender_210036" id="radio" value="" size="22" required> Female
          </div>
          <div class="one_third">
          ...
          <div class="one_third first">
            ...
            <input type="number" name="pet_age_210036" id="age" value="" size="22">
          </div>
          <div class="one_third">
            <label for="owner">Owner <span>*</span></label>
            <input type="text" name="pet_owner_210036" id="owner" value="" size="22">
          </div>
          <div class="one_third">
            <label for="name">Phone <span>*</span></label>
            <input type="text" name="pet_phone_210036" id="name" value="" size="22" required>
          </div>
          <div class="block clear">
            <label for="address">Address</label>
            <textarea name="pet_address_210036" id="address" cols="25" rows="10"></textarea>
          </div>
          <div>
